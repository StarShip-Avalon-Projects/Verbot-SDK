...
namespace Conversive.Verbot5
{
    ...
    public class TextToolbox
    {
        ...
        /// </summary>
        /// <param name="stFileNameOrFullPath">
        /// </param>
        /// <returns>
        /// To Lower of the file extension with the period (i.e. ".ckb")
        /// </returns>
        ...
        /// </summary>
        /// <param name="stInput">
        /// stInput to generates inputs from
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="maxSize">
        /// maximum number of words in each permutation
        /// </param>
        /// <returns>
        /// list of word permutations
        /// </returns>
        ...
        {
            // Examples: IsExcaped( hello , 2) -> false IsEscaped( test "this" , 5) -> false
            // IsEscaped( test \"this\", 6) -> true IsEscaped( test \\"this", 7) -> false IsEscaped(
            // test \\\"this", 8) -> true
        ...
        /// change text
        /// </param>
        /// <param name="inputReplacements">
        /// list of Replacements
        /// </param>
        /// <returns>
        /// resulting replaced text
        /// </returns>
        ...
        public static string ReplaceSynonyms(string input, Dictionary<string, Synonym> synonyms)
        {
            ...
            while (start != -1)
            {
                ...
                if (end != -1)
                {
                    string synonymName = input.Substring(start + 2, end - start - 3).Trim().ToLower();
