...
namespace Conversive.Verbot5
{
    ...
    public class CompiledKnowledgeBase : ISerializable
    {
        ...
        //This is just used for comparison when reloading
        ...
        public string DoTextReplacements(string FurreName, string text)
        {
            foreach (Replacement r in this.replacements)
            {
                if (r.TextToFind != null && r.TextToFind != "")
        ...
        //GetReply(string FurreName, string input, string lastfired)
    ...
    public class Verbot5Engine
    {
        ...
        TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time"));
            ...
            state.Vars["furrename"] = "";
            state.Vars["furregender"] = "";
            state.Vars["furrespecies"] = "";
