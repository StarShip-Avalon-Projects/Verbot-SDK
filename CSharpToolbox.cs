...
namespace Conversive.Verbot5
{
    ...
    public class CSharpToolbox
    {
        ...
        private Dictionary<Thread, Job> threadJobs;
        ...
        //keys are Thread objects, values are jobs or results
        ...
        //keys are ids, values are condition strings
        //keys are ids, values are output strings
